...
public class ImagePHash {
    ...
    public ImagePHash(boolean trim)
    {
        this();
        this.trim = trim;
    ...
    public int distance(URL image1, URL image2) throws Exception
    {
    ...
    public int distance (BufferedImage image1, BufferedImage image2) throws Exception
    {
