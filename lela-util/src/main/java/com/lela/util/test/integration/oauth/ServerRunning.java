...
package com.lela.util.test.integration.oauth;
...
public class ServerRunning extends TestWatchman {
	...
	private static String DEFAULT_HOST = "dev.lela.com";
	...
	public Statement apply(Statement base, FrameworkMethod method, Object target) {
		...
		try {
			client.getForEntity(new UriTemplate(getUrl("/lela/login")).toString(), String.class);
			online = true;
