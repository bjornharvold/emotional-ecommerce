...
public class Remix {
    ...
    public ProductsResponse getProducts() throws RemixException {
        return getProducts(null, null, RemixUtil.AND_DELIMITER);
    }
    ...
    public ProductsResponse getProducts(List<String> filters) throws RemixException {
        return getProducts(filters, null, RemixUtil.AND_DELIMITER);
    }
    ...
    public ProductsResponse getProducts(Map<String,String> params) throws RemixException {
        return getProducts(null, params, RemixUtil.AND_DELIMITER);
    }
     ...
     * @throws RemixException 
     */
    public ProductsResponse getProducts(List<String> filters, Map<String,String> params, String filterDelimiter) throws RemixException {
        String uri = PATH_PRODUCTS + RemixUtil.buildFilterString(filters, filterDelimiter);
    ...
    public StoresResponse getStores(List<String> filters, Map<String,String> params) throws RemixException {
        String uri = PATH_STORES + RemixUtil.buildFilterString(filters, RemixUtil.AND_DELIMITER);
    ...
    public StoresResponse getStoreAvailability(
        ...
        String uri = PATH_STORES   + RemixUtil.buildFilterString(storeFilters, RemixUtil.AND_DELIMITER) + "+" +
                     PATH_PRODUCTS + RemixUtil.buildFilterString(productFilters, RemixUtil.AND_DELIMITER);
        return new StoresResponse(query("GET", uri, params));
    }
    ...
    private HttpURLConnection query(String method, String uri, Map<String,String> params) throws RemixException {
        ...
        try {
            ...
            String urlString = ENTRY_POINT + uri + RemixUtil.buildQueryString(params);
