...
public abstract class AbstractResponse
{
    ...
    private BigDecimal boxUsage;

    public BigDecimal getBoxUsage()
    {
        return boxUsage;
    }

    public void setBoxUsage(BigDecimal boxUsage)
    {
    ...
    protected AbstractResponse()
    {
        ...
        getDigester().addBeanPropertySetter(getTopElementName() + "/ResponseMetadata/BoxUsage", "boxUsage");
    }
