 ...
 */
public class ItemSearchByDateCreatedServiceImpl implements ItemSearchService{
    ...
    {
        return Item.findItemsByCategoryByProductImageDateCreated(category, brand, itemStatus, itemId, productModelName, reviewStatusId, page, PAGE_SIZE, order);
    }
}
