...
import com.lela.data.web.CountryController;
...
privileged aspect CountryController_Roo_Controller {
    ...
    public String CountryController.create(@Valid Country country, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            ...
            return "crud/countrys/create";
        }
        uiModel.asMap().clear();
        country.persist();
        return "redirect:/crud/countrys/" + encodeUrlPathSegment(country.getId().toString(), httpServletRequest);
    }
    ...
    public String CountryController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        ...
        return "redirect:/crud/countrys";
    }
    
    void CountryController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("country_datecreated_date_format", "yyy-MM-dd hh:mm:ss a");
        uiModel.addAttribute("country_datemodified_date_format", "yyy-MM-dd hh:mm:ss a");
    }
