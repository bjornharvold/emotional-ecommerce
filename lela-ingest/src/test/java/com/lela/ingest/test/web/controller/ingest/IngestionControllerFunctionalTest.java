...
import com.lela.domain.dto.AffiliateAccounts;
import com.lela.domain.dto.Branches;
import com.lela.domain.dto.Campaigns;
import com.lela.domain.dto.Categories;
import com.lela.domain.dto.FunctionalFilters;
import com.lela.domain.dto.Items;
import com.lela.domain.dto.Metrics;
import com.lela.domain.dto.NavigationBars;
import com.lela.domain.dto.ObjectIds;
...
import com.lela.domain.dto.Roles;
import com.lela.domain.dto.Stores;
import com.lela.domain.dto.StringList;
...
import com.lela.ingest.web.controller.ingest.IngestionController;
...
public class IngestionControllerFunctionalTest extends AbstractFunctionalTest {
    ...
    public void testIngestUsers() {
        ...
        try {
            ...
            assertFalse("User should be disabled", user.getNbld());
    ...
    public void testIngestFunctionalFilters() {
        ...
        try {
            ...
            List<FunctionalFilter> filters2 = functionalFilterService.findFunctionalFiltersByCategoryUrlName(ff.getRlnm());
            ...
            filters2 = functionalFilterService.findFunctionalFiltersByCategoryUrlName(ff.getRlnm());
