...
Lela.getCookie = function(name) {
return (r = new RegExp('(?:^|; )' + name + '=([^;]*)').exec(document.cookie)) ? (r[1]) : null;
};

Lela.setCookie = function(name, value, days) {
var dt=new Date();
...
(function(global) {
    ...
    Lela.lelacd = Lela.getCookie('_lelacd');

    Lela.LAB = $LAB.wait();

    if (Lela.requireJQuery()) {
        if (console) console.log("Loading jQuery");
        //Lela.LAB.script(Lela.baseUrl + "/static/js/jquery-1.7.1.js").wait(function() {
    ...
    Lela.loadCss(Lela.baseUrl + '/static/quiz/quiz.css');

    Lela.LAB.script(Lela.baseUrl + "/static/js/plugins/jquery.blockUI.js")
           .script(Lela.baseUrl + "/static/js/plugins/json2.js")
           .script(Lela.baseUrl + "/static/js/plugins/xdr.js")
//           .script(Lela.baseUrl + "/static/js/handlebars-1.0.0.beta6.min.js")
//           .script(Lela.baseUrl + "/static/js/ember-latest.min.js").wait()
           .script(Lela.baseUrl + "/static/js/ember-handlebars.min.js").wait()
           .script(Lela.baseUrl + "/static/quiz/quiz-api.js");
})(this);