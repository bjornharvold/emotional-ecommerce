...
public class DigicamMotivator_C extends ATestHarness {
	    ...
	    public String   getRuleSetName()          { return "DigicamMotivator_C";             }
	    public String   getDecisionTableName()    { return "Digicam_MC_Calculate";           }
	    public String   getRulesDirectoryFile()   { return "DTRules.xml";                    }             
	   
	    public static void main(String[] args) {
	        ITestHarness t = new DigicamMotivator_C();
	        t.runTests();
	    }
