 ...
 */
public class FacebookMotivator_F extends ATestHarness {
	    ...
	    public String   getRuleSetName()          { return "FacebookMotivator_F";                        }
	    public String   getDecisionTableName()    { return "Facebook_MF_Calculate";           }
	    public String   getRulesDirectoryFile()   { return "DTRules.xml";                   }

	    public static void main(String[] args) {
	        ITestHarness t = new FacebookMotivator_F();
	        t.runTests();
	    }
