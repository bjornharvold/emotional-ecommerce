...
public class TestCribMotivator_C extends ATestHarness {
	    ...
	    public String   getRuleSetName()          { return "CribMotivator_C";                        }
	    public String   getDecisionTableName()    { return "CRIBS_MC_Calculate";           }
	    public String   getRulesDirectoryFile()   { return "DTRules.xml";                   }             
	   
	    public static void main(String[] args) {
	        ITestHarness t = new TestCribMotivator_C();
	        t.runTests();
	    }
