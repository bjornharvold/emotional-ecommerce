 ...
 */
public class FacebookMotivator_D extends ATestHarness {
	    ...
	    public String   getRuleSetName()          { return "FacebookMotivator_D";                        }
	    public String   getDecisionTableName()    { return "Facebook_MD_Calculate";           }
	    public String   getRulesDirectoryFile()   { return "DTRules.xml";                   }

	    public static void main(String[] args) {
	        ITestHarness t = new FacebookMotivator_D();
	        t.runTests();
	    }
