...
public class DigicamMotivator_B extends ATestHarness {
    
	    public boolean  Trace()                   { return true;                            }
	    public boolean  Console()                 { return true;                            }
	    public String   getPath()                 { return CompileMotivators.path;              }
	    public String   getRulesDirectoryPath()   { return getPath()+"xml/DigitalCameras/";                }
	    public String   getRuleSetName()          { return "DigicamMotivator_B";                        }
	    public String   getDecisionTableName()    { return "Digicam_MB_Calculate";           }
	    public String   getRulesDirectoryFile()   { return "DTRules.xml";                   }             
	   
	    public static void main(String[] args) {
	        ITestHarness t = new DigicamMotivator_B();
	        t.runTests();
	    }
	    ...
	    public void printReport(int runNumber, IRSession session, PrintStream _out) throws RulesException {
	         ...
	         System.out.println("brandId result: " + brandId.intValue());
