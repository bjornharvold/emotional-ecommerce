...
public class TelevisionMotivator_B extends ATestHarness {
	    ...
	    public String   getRuleSetName()          { return "TelevisionMotivator_B";                        }
	    public String   getDecisionTableName()    { return "Television_MB_Calculate";           }
	    public String   getRulesDirectoryFile()   { return "DTRules.xml";                   }             
	   
	    public static void main(String[] args) {
	        ITestHarness t = new TelevisionMotivator_B();
	        t.runTests();
	    }
