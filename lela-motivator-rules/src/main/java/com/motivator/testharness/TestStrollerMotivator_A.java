...
public class TestStrollerMotivator_A extends ATestHarness {
	    ...
	    public String   getRuleSetName()          { return "StrollerMotivator_A";      }
	    public String   getDecisionTableName()    { return "MA_Calculate";             }
	    public String   getRulesDirectoryFile()   { return "DTRules.xml";              }             
	   
	    public static void main(String[] args) {
	        ITestHarness t = new TestStrollerMotivator_A();
	        t.runTests();
	    }
