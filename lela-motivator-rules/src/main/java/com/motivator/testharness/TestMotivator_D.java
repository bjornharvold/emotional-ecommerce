...
public class TestMotivator_D extends ATestHarness {
    ...
    public String   getRuleSetName()          { return "BabyMonitorMotivator_D";                        }
    public String   getDecisionTableName()    { return "BabyMonitor_MD_Calculate";           }
    public String   getRulesDirectoryFile()   { return "DTRules.xml";                   }             
	   
	    public static void main(String[] args) {
	        ITestHarness t = new TestMotivator_D();
	        t.runTests();
	    }
	    ...
	    public void printReport(int runNumber, IRSession session, PrintStream _out) throws RulesException {
	    	 ...
	    	 RArray   results = job.get("job.babymonitors").rArrayValue();
	    }
