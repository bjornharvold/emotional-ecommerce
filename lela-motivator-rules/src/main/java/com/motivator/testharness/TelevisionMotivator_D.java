...
public class TelevisionMotivator_D extends ATestHarness {
	    ...
	    public String   getRuleSetName()          { return "TelevisionMotivator_D";                        }
	    public String   getDecisionTableName()    { return "Television_MD_Calculate";           }
	    public String   getRulesDirectoryFile()   { return "DTRules.xml";                   }             
	   
	    public static void main(String[] args) {
	        ITestHarness t = new TelevisionMotivator_D();
	        t.runTests();
	    }
