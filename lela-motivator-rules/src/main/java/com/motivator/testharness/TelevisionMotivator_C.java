...
public class TelevisionMotivator_C extends ATestHarness {
	    ...
	    public String   getRuleSetName()          { return "TelevisionMotivator_C";                        }
	    public String   getDecisionTableName()    { return "Television_MC_Calculate";           }
	    public String   getRulesDirectoryFile()   { return "DTRules.xml";                   }             
	   
	    public static void main(String[] args) {
	        ITestHarness t = new TelevisionMotivator_C();
	        t.runTests();
	    }
