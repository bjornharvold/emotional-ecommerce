 ...
 */
public class FacebookMotivator_B extends ATestHarness {
	    ...
	    public String   getRuleSetName()          { return "FacebookMotivator_B";                        }
	    public String   getDecisionTableName()    { return "Facebook_MB_Calculate";           }
	    public String   getRulesDirectoryFile()   { return "DTRules.xml";                   }

	    public static void main(String[] args) {
	        ITestHarness t = new FacebookMotivator_B();
	        t.runTests();
	    }
