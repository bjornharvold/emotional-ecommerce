...
public class TestCribMotivator_G extends ATestHarness {
	    ...
	    public String   getRuleSetName()          { return "CribMotivator_G";                        }
	    public String   getDecisionTableName()    { return "CRIBS_MG_Calculate";           }
	    public String   getRulesDirectoryFile()   { return "DTRules.xml";                   }             
	   
	    public static void main(String[] args) {
	        ITestHarness t = new TestCribMotivator_G();
	        t.runTests();
	    }
