...
public class TestMotivator_C extends ATestHarness {
    ...
    public String   getRuleSetName()          { return "BabyMonitorMotivator_C";                        }
    public String   getDecisionTableName()    { return "BabyMonitor_MC_Calculate";           }
    public String   getRulesDirectoryFile()   { return "DTRules.xml";                   }             
	   
	    public static void main(String[] args) {
	        ITestHarness t = new TestMotivator_C();
	        t.runTests();
	    }
