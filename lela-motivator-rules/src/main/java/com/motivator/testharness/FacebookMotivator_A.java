 ...
 */
public class FacebookMotivator_A extends ATestHarness {
	    ...
	    public String   getRuleSetName()          { return "FacebookMotivator_A";                        }
	    public String   getDecisionTableName()    { return "Facebook_MA_Calculate";           }
	    public String   getRulesDirectoryFile()   { return "DTRules.xml";                   }

	    public static void main(String[] args) {
	        ITestHarness t = new FacebookMotivator_A();
	        t.runTests();
	    }
