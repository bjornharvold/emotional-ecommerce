...
public class TestCarSeatsMotivator_A extends ATestHarness {
    
	    public boolean  Trace()                   { return true;                            }
	    public boolean  Console()                 { return true;                            }
	    public String   getPath()                 { return CompileMotivators.path;              }
	    public String   getRulesDirectoryPath()   { return getPath()+"xml/CarSeats/";                }
	    public String   getRuleSetName()          { return "CarSeatsMotivator_A";                        }
	    public String   getDecisionTableName()    { return "CarSeats_MA_Calculate";           }
	    public String   getRulesDirectoryFile()   { return "CarSeats_DTRules.xml";                   }             
	   
	    public static void main(String[] args) {
	        ITestHarness t = new TestCarSeatsMotivator_A();
	        t.runTests();
	    }
	    ...
	    public void printReport(int runNumber, IRSession session, PrintStream _out) throws RulesException {
	    	 ...
	    	 RArray   results = job.get("job.carseats").rArrayValue();
	    }
