...
public class TelevisionMotivator_F extends ATestHarness {
	    ...
	    public String   getRuleSetName()          { return "TelevisionMotivator_F";                        }
	    public String   getDecisionTableName()    { return "Television_MF_Calculate";           }
	    public String   getRulesDirectoryFile()   { return "DTRules.xml";                   }             
	   
	    public static void main(String[] args) {
	        ITestHarness t = new TelevisionMotivator_F();
	        t.runTests();
	    }
