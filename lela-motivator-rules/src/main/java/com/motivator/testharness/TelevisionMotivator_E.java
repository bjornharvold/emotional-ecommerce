...
public class TelevisionMotivator_E extends ATestHarness {
	    ...
	    public String   getRuleSetName()          { return "TelevisionMotivator_E";                        }
	    public String   getDecisionTableName()    { return "Television_ME_Calculate";           }
	    public String   getRulesDirectoryFile()   { return "DTRules.xml";                   }             
	   
	    public static void main(String[] args) {
	        ITestHarness t = new TelevisionMotivator_E();
	        t.runTests();
	    }
