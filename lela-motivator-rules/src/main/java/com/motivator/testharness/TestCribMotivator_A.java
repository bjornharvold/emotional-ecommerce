...
public class TestCribMotivator_A extends ATestHarness {
	    ...
	    public String   getRuleSetName()          { return "CribMotivator_A";                        }
	    public String   getDecisionTableName()    { return "CRIBS_MA_Calculate";           }
	    public String   getRulesDirectoryFile()   { return "DTRules.xml";                   }             
	   
	    public static void main(String[] args) {
	        ITestHarness t = new TestCribMotivator_A();
	        t.runTests();
	    }
