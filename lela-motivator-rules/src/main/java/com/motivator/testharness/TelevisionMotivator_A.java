...
public class TelevisionMotivator_A extends ATestHarness {
	    ...
	    public String   getRuleSetName()          { return "TelevisionMotivator_A";                        }
	    public String   getDecisionTableName()    { return "Television_MA_Calculate";           }
	    public String   getRulesDirectoryFile()   { return "DTRules.xml";                   }             
	   
	    public static void main(String[] args) {
	        ITestHarness t = new TelevisionMotivator_A();
	        t.runTests();
	    }
