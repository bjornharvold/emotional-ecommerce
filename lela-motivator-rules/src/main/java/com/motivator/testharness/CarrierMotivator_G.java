...
public class CarrierMotivator_G extends ATestHarness {
    
	    public boolean  Trace()                   { return true;                            }
	    public boolean  Console()                 { return true;                            }
	    public String   getPath()                 { return CompileMotivators.path;              }
	    public String   getRulesDirectoryPath()   { return getPath()+"xml/Carriers/";                }
	    public String   getRuleSetName()          { return "CarrierMotivator_G";                        }
	    public String   getDecisionTableName()    { return "Carrier_MG_Calculate";           }
	    public String   getRulesDirectoryFile()   { return "DTRules.xml";                   }             
	   
	    public static void main(String[] args) {
	        ITestHarness t = new CarrierMotivator_G();
	        t.runTests();
	    }
