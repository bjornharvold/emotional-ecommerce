...
public class DigicamMotivator_D extends ATestHarness {
	    ...
	    public String   getRuleSetName()          { return "DigicamMotivator_D";             }
	    public String   getDecisionTableName()    { return "Digicam_MD_Calculate";           }
	    public String   getRulesDirectoryFile()   { return "DTRules.xml";                    }             
	   
	    public static void main(String[] args) {
	        ITestHarness t = new DigicamMotivator_D();
	        t.runTests();
	    }
