...
public class TestCribMotivator_D extends ATestHarness {
	    ...
	    public String   getRuleSetName()          { return "CribMotivator_D";                        }
	    public String   getDecisionTableName()    { return "CRIBS_MD_Calculate";           }
	    public String   getRulesDirectoryFile()   { return "DTRules.xml";                   }             
	   
	    public static void main(String[] args) {
	        ITestHarness t = new TestCribMotivator_D();
	        t.runTests();
	    }
