...
public class TestCribMotivator_E extends ATestHarness {
	    ...
	    public String   getRuleSetName()          { return "CribMotivator_E";                        }
	    public String   getDecisionTableName()    { return "CRIBS_ME_Calculate";           }
	    public String   getRulesDirectoryFile()   { return "DTRules.xml";                   }             
	   
	    public static void main(String[] args) {
	        ITestHarness t = new TestCribMotivator_E();
	        t.runTests();
	    }
