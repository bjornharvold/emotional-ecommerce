...
public class TestMotivator_B extends ATestHarness {
	    ...
	    public String   getRuleSetName()          { return "BabyMonitorMotivator_B";                        }
	    public String   getDecisionTableName()    { return "BabyMonitor_MB_Calculate";           }
	    public String   getRulesDirectoryFile()   { return "DTRules.xml";                   }             
	   
	    public static void main(String[] args) {
	        ITestHarness t = new TestMotivator_B();
	        t.runTests();
	    }
