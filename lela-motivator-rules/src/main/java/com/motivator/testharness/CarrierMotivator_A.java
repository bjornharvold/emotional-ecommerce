...
public class CarrierMotivator_A extends ATestHarness {
	    ...
	    public String   getRuleSetName()          { return "CarrierMotivator_A";                        }
	    public String   getDecisionTableName()    { return "Carrier_MA_Calculate";           }
	    public String   getRulesDirectoryFile()   { return "DTRules.xml";                   }             
	   
	    public static void main(String[] args) {
	        ITestHarness t = new CarrierMotivator_A();
	        t.runTests();
	    }
