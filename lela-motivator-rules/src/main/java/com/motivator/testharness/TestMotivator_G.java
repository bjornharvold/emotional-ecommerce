...
public class TestMotivator_G extends ATestHarness {
	    ...
	    public String   getRuleSetName()          { return "StrollerMotivator_G";                        }
	    public String   getDecisionTableName()    { return "MG_Calculate";           }
	    public String   getRulesDirectoryFile()   { return "DTRules.xml";                   }             
	   
	    public static void main(String[] args) {
	        ITestHarness t = new TestMotivator_G();
	        t.runTests();
	    }
