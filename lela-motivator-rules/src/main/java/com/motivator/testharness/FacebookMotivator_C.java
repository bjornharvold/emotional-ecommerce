 ...
 */
public class FacebookMotivator_C extends ATestHarness {
	    ...
	    public String   getRuleSetName()          { return "FacebookMotivator_C";                        }
	    public String   getDecisionTableName()    { return "Facebook_MC_Calculate";           }
	    public String   getRulesDirectoryFile()   { return "DTRules.xml";                   }

	    public static void main(String[] args) {
	        ITestHarness t = new FacebookMotivator_C();
	        t.runTests();
	    }
